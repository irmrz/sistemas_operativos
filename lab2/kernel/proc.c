...
struct semaphore array_sem[MAX_SEMAPHORE];
...
sys_sem_close(void)
{
  ...
  /* Return to user state of value before call sem close*/
  old_value = array_sem[sem].value;

  /* Set init value*/
  array_sem[sem].value = -1;
...
sys_sem_up(void)
{
	...
	array_sem[sem].value = array_sem[sem].value + 1;
