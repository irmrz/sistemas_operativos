...
bool
fat_table_is_valid_cluster_number(const fat_table table, u32 cluster);
 ...
 */
void
fat_table_set_next_cluster(fat_table table, u32 cur_cluster, u32 next_cluster);
 ...
 */
void
fat_table_print(fat_table table, u32 start_cluster, u32 end_cluster);
