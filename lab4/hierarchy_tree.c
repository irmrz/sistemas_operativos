...
static h_tree
h_node_init(void* new_data, h_tree h_parent)
{
  h_tree new_node;
...
void
h_tree_destroy(h_tree root, data_modify_fn data_destroy)
{
  if (root == NULL)
    return;
...
static inline bool
is_minimum(const h_tree root)
{
  return root->left == NULL;
}

static void
swap_nodes(h_tree old_file, h_tree new_file)
{
 ...
 */
static void
remove_child_from_h(h_tree h_child)
{
...
static h_tree
delete_root(h_tree root, data_modify_fn data_destroy)
{
  h_tree minimum = NULL;
  if (root->data != NULL) {
    data_destroy(root->data);
...
void
h_tree_iterate_preorder(h_tree root, data_modify_fn mod_fn)
{
  if (root != NULL) {
...
void
h_tree_iterate_h_ancestors(h_tree root, data_modify_fn mod_fn)
{
...
void
h_tree_flatten_preorder(const h_tree root, void** elem_array)
{
  if (root != NULL) {
